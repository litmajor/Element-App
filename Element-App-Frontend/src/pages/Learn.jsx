...
export const Learn = () => {
  return (
    <>
      <section className='learn mb-16'>
        <div className='container'>
          <div className='heading py-12 text-center w-2/3 m-auto md:w-full'>
            <h1 className='text-3xl font-semibold text-black'>What Does Element Offer?</h1>
            <span className='text-[14px] mt-2 block'>Learn more about Element and share your experience</span>
          </div>
          <div className='content grid grid-cols-2 gap-5 md:grid-cols-1'>
            <div className='images rounded-lg relative overflow-hidden h-72 w-ful before:bg-backbg before:h-72 before:w-full before:absolute before:top-0 before:left-0 before:content before:z-10'>
              ...
              <div className='categ flex flex-col gap-4 absolute top-5 z-30 m-3 p-8 items-center justify-center text-center'>
                <h2 className='text-3xl text-white font-semibold'>Oh my, get the services</h2>
                <button className='text-[15px] py-2 px-4 border border-gray-200 rounded-md text-white'>Oh my, get the services</button>
              </div>
            </div>
            <div className='images rounded-lg relative overflow-hidden h-72 w-ful before:bg-backbg before:h-72 before:w-full before:absolute before:top-0 before:left-0 before:content before:z-10'>
          ...
          <div className='content'>
            ...
            <div className='content grid grid-cols-4 gap-5 md:grid-cols-2'>
              <LearnCard color='text-red-500' icon={<FaUsers size={40} />} title='55' desc='Freelancers Signed up' />
              <LearnCard color='text-orange-500' icon={<GiEvilBook size={40} />} title='20' desc='Payments' />
              <LearnCard color='text-indigo-500' icon={<GiWorld size={40} />} title='4' desc='Countries' />
            </div>
          </div>
        </div>
      </section>
